...
import io.sphere.json.generic.JSONTypeHint2
import io.sphere.json.generic.derive.MagnoliaToJSONDerivation
import org.json4s.JValue
import org.json4s.JsonAST.JNothing
import org.json4s.jackson.JsonMethods.{compact, render}
import org.scalatest.{MustMatchers, WordSpec}

class DeriveSingletonJSON2Spec extends WordSpec with MustMatchers {
  import DeriveSingletonJSON2Spec._
...
object DeriveSingletonJSON2Spec {
  ...
  object PictureSize {
    // TODO: create deriveSingletonJSON
    implicit val json: ToJSON[PictureSize] = MagnoliaToJSONDerivation.deriveToJSON
  }
  ...
  object Access {
    ...
    implicit val json: ToJSON[Access] = MagnoliaToJSONDerivation.deriveToJSON
  }
  ...
  object UserWithPicture {
    implicit val json: ToJSON[UserWithPicture] = MagnoliaToJSONDerivation.deriveToJSON
  }
}
