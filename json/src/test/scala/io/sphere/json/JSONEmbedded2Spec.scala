...
object JSONEmbedded2Spec {

  case class Embedded(value1: String, value2: Int)

  object Embedded {
    implicit val json: JSON[Embedded] = MagnoliaJSONDerivation.jsonProduct
  }

  case class Test1(
    name: String,
    @JSONEmbedded2 embedded: Embedded)

  object Test1 {
    implicit val json: JSON[Test1] = MagnoliaJSONDerivation.jsonProduct
  }

  case class Test2(
    name: String,
    @JSONEmbedded2 embedded: Option[Embedded] = None)

  object Test2 {
    implicit val json: JSON[Test2] = MagnoliaJSONDerivation.jsonProduct
  }

  case class SubTest4(@JSONEmbedded2 embedded: Embedded)
  object SubTest4 {
    implicit val json: JSON[SubTest4] = MagnoliaJSONDerivation.jsonProduct
  }

  case class Test4(subField: Option[SubTest4] = None)
  object Test4 {
    implicit val json: JSON[Test4] = MagnoliaJSONDerivation.jsonProduct
  }
}

class JSONEmbedded2Spec extends WordSpec with MustMatchers with OptionValues {
  import JSONEmbedded2Spec._
