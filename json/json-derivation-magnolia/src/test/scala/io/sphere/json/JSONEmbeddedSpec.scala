...
object JSONEmbeddedSpec {
  ...
  object Embedded {
    implicit val json: JSON[Embedded] = jsonProduct
  }
  ...
  object Test1 {
    implicit val json: JSON[Test1] = jsonProduct
  }
  ...
  object Test2 {
    implicit val json: JSON[Test2] = jsonProduct
  }

  case class SubTest4(@JSONEmbedded embedded: Embedded)
  object SubTest4 {
    implicit val json: JSON[SubTest4] = jsonProduct
  }

  case class Test4(subField: Option[SubTest4] = None)
  object Test4 {
    implicit val json: JSON[Test4] = jsonProduct
  }
}
